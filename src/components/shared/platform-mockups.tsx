  ...
  return (
    <div className="overflow-hidden rounded-xl border border-gray-200 bg-white">
      <div className="flex items-start gap-2.5 p-3">
        <Avatar userName={userName} userImage={userImage} size="md" />
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1">
            <span className="text-sm font-bold text-gray-900 truncate">{userName}</span>
            <svg className="h-4 w-4 flex-shrink-0 text-[#1d9bf0]" viewBox="0 0 24 24" fill="currentColor">
          ...
          <p className="mt-1 whitespace-pre-wrap text-sm leading-relaxed text-gray-900">{content}</p>
          <div className="mt-2 flex justify-between max-w-[300px] text-gray-400">
            <MessageCircle className="h-4 w-4 hover:text-[#1d9bf0]" />
            <Repeat2 className="h-4 w-4 hover:text-green-500" />
            <Heart className="h-4 w-4 hover:text-pink-500" />
            <Bookmark className="h-4 w-4 hover:text-[#1d9bf0]" />
            <Share className="h-4 w-4 hover:text-[#1d9bf0]" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="overflow-hidden rounded-xl border border-gray-200 bg-white">
      <div className="flex items-center gap-2.5 px-3 py-2.5">
        <div className="overflow-hidden rounded-full bg-gradient-to-br from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] p-[2px]">
          <div className="h-7 w-7 overflow-hidden rounded-full bg-white p-[1px]">
            {userImage ? (
              // eslint-disable-next-line @next/next/no-img-element
    ...
    <div className="overflow-hidden rounded-xl border border-gray-800 bg-gray-950">
      <div className="flex items-start gap-2.5 p-3">
        <div className="flex-shrink-0">
          <div className="h-8 w-8 overflow-hidden rounded-full border-2 border-gray-700 bg-gray-700">
            {userImage ? (
              // eslint-disable-next-line @next/next/no-img-element
              <img src={userImage} alt="" className="h-full w-full object-cover" />
            ) : (
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="mt-1 whitespace-pre-wrap text-[13px] leading-relaxed text-white/90">{content}</p>
          <div className="mt-2 flex items-center gap-1.5">
            <Music className="h-3 w-3 text-white/50" />
            <p className="text-[11px] text-white/50">Original sound - {userName}</p>
          </div>
          <div className="mt-2 flex gap-4 text-white/50">
